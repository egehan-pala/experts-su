...
export default function Home() {
  ...
  const [overviewTab, setOverviewTab] = useState<'sdgs' | 'networks' | 'world'>('sdgs');
  const [networkSubTab, setNetworkSubTab] = useState<'school' | 'citation'>('school');
  const limit = 12;
                  ...
                  {[
                    ...
                    return (
                      <button
                        ...
                        onClick={() => setOverviewTab(tab.id as 'sdgs' | 'networks' | 'world')}
                        style={{
                          display: 'flex',
                          alignItems: 'center',
                          padding: '1rem 0.25rem',
