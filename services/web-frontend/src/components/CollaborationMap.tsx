...
export default function CollaborationMap({ authorId, selectedYear }: Props) {
  ...
  const [sinceYear, setSinceYear] = useState<string>("2020");
  const [debouncedSinceYear, setDebouncedSinceYear] = useState<string>("2020");
  ...
  const dynamicColorScale = useMemo(() => {
    return scaleLinear<string>()
      ...
      .range(["#fca5a5", "#d6001c"]); // From light red to Sabancı Red
  }, [maxCount]);
    ...
    <section style={{
      ...
      <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 5vw', boxSizing: 'border-box' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '1rem', marginTop: '2rem' }}>
            ...
            width: '200px', 
            height: '8px', 
            background: 'linear-gradient(to right, #fca5a5, #d6001c)',
            borderRadius: '4px',
            border: '1px solid #334155'
            }} />
