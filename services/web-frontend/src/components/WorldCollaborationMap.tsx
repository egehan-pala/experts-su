    ...
    <div style={{
        ...
        >
          <ZoomableGroup>
            ...
            {data.map((country) => {
              ...
              let currentRadius = r;
              let currentFill = `rgba(37, 99, 235, ${opacity})`;
              let currentStroke = `rgba(37, 99, 235, ${Math.min(opacity + 0.2, 1)})`;

              if (isSelected) {
                currentRadius = r * 1.5;
                currentFill = 'rgba(29, 78, 216, 1)';
                currentStroke = 'rgba(30, 64, 175, 1)';
              } else if (hasSelection) {
                currentRadius = r * 0.5;
                currentFill = `rgba(37, 99, 235, ${opacity * 0.3})`;
                currentStroke = `rgba(37, 99, 235, ${Math.min(opacity * 0.3 + 0.1, 1)})`;
              }
              ...
              return (
                ...
                >
                  <circle
                    ...
                    onMouseOver={(e) => {
                      if (!isSelected) {
                        (e.target as SVGCircleElement).setAttribute('fill', 'rgba(29, 78, 216, 0.9)');
                        (e.target as SVGCircleElement).setAttribute('r', String(r * 1.3));
                      }
                    }}
                    onMouseOut={(e) => {
                      if (!isSelected) {
                        (e.target as SVGCircleElement).setAttribute('fill', currentFill);
                        (e.target as SVGCircleElement).setAttribute('r', String(currentRadius));
                      }
                    }}
                  />
                </Marker>
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ 
            width: '50px', height: '50px', borderRadius: '12px', background: '#dbeafe', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '1.5rem', marginRight: '1rem' 
          }}>🌍</div>
          <div>
            <div style={{ fontSize: '0.8rem', color: '#64748b', fontWeight: 600, textTransform: 'uppercase', letterSpacing: '0.05em' }}>Total Countries</div>
            <div style={{ fontSize: '1.75rem', color: '#1e3a8a', fontWeight: 800, marginTop: '0.2rem' }}>{totalCountries}</div>
          </div>
        </div>
        ...
        <div style={{
          ...
          <div style={{ 
            width: '50px', height: '50px', borderRadius: '12px', background: '#dcfce7', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '1.5rem', marginRight: '1rem' 
          }}>🤝</div>
          <div>
            <div style={{ fontSize: '0.8rem', color: '#64748b', fontWeight: 600, textTransform: 'uppercase', letterSpacing: '0.05em' }}>Faculty-Country Links</div>
            <div style={{ fontSize: '1.75rem', color: '#14532d', fontWeight: 800, marginTop: '0.2rem' }}>{totalCollabs.toLocaleString()}</div>
          </div>
        </div>
        ...
        {data[0] && (
          <div style={{
            ...
            <div style={{ 
              width: '50px', height: '50px', borderRadius: '12px', background: '#fef08a', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '1.5rem', marginRight: '1rem' 
            }}>🏆</div>
            <div>
              <div style={{ fontSize: '0.8rem', color: '#64748b', fontWeight: 600, textTransform: 'uppercase', letterSpacing: '0.05em' }}>Top Partner</div>
              <div style={{ fontSize: '1.35rem', color: '#78350f', fontWeight: 800, lineHeight: '1.2', marginTop: '0.2rem' }}>
                {data[0].names[0] || data[0].code}
              </div>
              <div style={{ fontSize: '0.85rem', color: '#92400e', fontWeight: 600, marginTop: '0.1rem' }}>
                {data[0].count} Collaborations
              </div>
            </div>
          </div>
        )}
